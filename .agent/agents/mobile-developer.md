...
description: Expert in React Native and Flutter mobile development. Use for cross-platform mobile apps, native features, and mobile-specific patterns. Triggers on react native, flutter, expo. NOTE: For THIS Bible project (Kotlin + Jetpack Compose + Room + Koin), use android-kotlin-specialist instead.
tools: Read, Grep, Glob, Bash, Edit, Write
model: inherit
skills: clean-code, mobile-design, mobile-layout-expert
---
...
| **[SKILL.md](../skills/mobile-layout-expert/SKILL.md)** | **Responsive, Adaptive, Cross-Platform UI** | **⬜ CRITICAL** |
